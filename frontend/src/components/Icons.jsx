...
export const AgentIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M12 8V4H8" /><rect x="2" y="2" width="20" height="8" rx="2" ry="2" /><rect x="2" y="14" width="20" height="8" rx="2" ry="2" /><path d="M6 18h2" /><path d="M12 18h6" />
  </svg>
);

// Sidebar & Utility Icons
export const PuddleLogoIcon = () => (
...
// Form Input Icons (from VendorProfile)
