    ...
    <div className="marketplace-container">
      <div className="marketplace-card">
        <div className="marketplace-header">
          <div>
            <h1>Marketplace</h1>
            <p>Browse all datasets and vendors in one place.</p>
          </div>
          <input
        ...
        {loading ? (
          <div className="marketplace-empty">Loading marketplace data...</div>
        ) : error ? (
          ...
          <>
            <section className="marketplace-section">
              <div className="section-header">
                <h2>Datasets</h2>
                <span>{filteredDatasets.length} results</span>
              </div>
              {filteredDatasets.length === 0 ? (
                <div className="marketplace-empty">No datasets match your search.</div>
              ) : (
            ...
            <section className="marketplace-section">
              ...
              {filteredVendors.length === 0 ? (
                <div className="marketplace-empty">No vendors match your search.</div>
              ) : (
